...
if df is not None:
    ...
    with tab2:
        ...
        with st.expander("🟢 Optimisation du Lien Relationnel (Scores inférieurs à 7)"):
            ...
            st.write("---")
            st.write("**10. Cible :** Clients avec personnes à charge (Familles)")
            st.write("**Action :** Offre Duo/Famille avec une réduction sur une seconde ligne mobile pour un membre du foyer afin de regrouper les contrats.")
            st.write("---")
    ...
    with tab3:
        ...
        st.video("demo_powerbi.mp4")
        st.caption("Tableau de bord décisionnel Power BI - Démonstration interactive")
